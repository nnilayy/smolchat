    ...
    <div className="flex flex-wrap justify-center gap-3 w-full max-w-4xl px-4 mt-4">
      {examples.map((example, index) => (
        <motion.div
          ...
          className={`flex flex-col gap-2 p-4 rounded-3xl border cursor-pointer hover:scale-[1.02] transition-transform duration-200 w-full sm:w-[calc(50%-0.75rem)] md:w-[calc(33.33%-0.75rem)] ${example.color}`}
